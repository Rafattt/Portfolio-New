...
function getWebGLContext(canvas) {
    ...
    gl.clearColor(0.0, 0.0, 0.0, 0.0); // Clear the canvas with a transparent color
    ...
    if (isWebGL2) {
        extensions.color_buffer_float = gl.getExtension('EXT_color_buffer_float');
    ...
    var texType = isWebGL2 ? gl.HALF_FLOAT : extensions.halfFloat.HALF_FLOAT_OES;
    ...
    return {
        ...
        support_linear_float: extensions.support_linear_float
    };
}
...
function m( t ) {
    ...
    for ( var e, n = document.getElementById( t ), i = n.innerHTML.replace( "&amp;", "&" ).split( "" ), a = "", o = 0, s = i.length; s > o; o++ ) {
        e = i[ o ].replace( "&", "&amp" );
        a += e.trim() ? '<span class="letter-' + o + '">' + e  : "&nbsp;";
    }
